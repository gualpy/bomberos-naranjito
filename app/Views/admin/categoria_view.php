...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <i class="fa fa-align-justify"></i> Detalle de Categoria
            <button type="button" class="btn" data-toggle="modal" data-target="#modalNuevo">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select col-md-4" id="opcion" name="opcion">
            ...
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="descripcion" name="descripcion"
                                           class="form-control" placeholder="Documentos">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label"
                                       for="email-input">Condición</label>
                                <div class="col-md-9">
                                    <select name="condicion" id="condicion" value="<?= isset($condicion) ? $$condicion : ''?>" class="form-control form-control-sm">
                                        <option value="activado">Activado</option>
                                        <option value="descativado">Desactivado</option>
                                    </select>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="guardarCategoria" type="button" class="btn btn-primary">Guardar</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
