      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-6 wow fadeInLeft ">
            <img src="assets/img/sistemaci.jpg" alt="">
          </div>
          <div class="col-xs-12 col-sm-6 wow fadeInRight">
            <a href="#"><p>EMISION DE PERMISOS DE FUNCIONAMIENTO
El permiso de funcionamiento es la autorización que el Cuerpo de Bomberos emite a todo local para su funcionamiento y que se enmarca dentro de la actividad. De acuerdo al marco legal vigente en el Reglamento de Prevención, Mitigación y Protección Contra Incendios del Registro Oficial Edición Especial Nº 114 del jueves 2 de abril de 2009, para la obtención del referido permiso se debe cumplir con los siguientes requisitos:
            ...
            <ul class="list2">
              <li><a href="#">-Adquirir en ventanilla formulario para solicitud para permiso de funcionamiento:</a></li>
              <li><a href="#">-Informe favorable de inspección sobre instalaciones y seguridad contra incendios</a></li>
              <li><a href="#">-Copia del RUC</a></li>
              <li><a href="#">-Copia del pago del impuesto predial</a></li>
              <li><a href="#">-Copia del permiso de funcionamiento del año anterior</a></li>
              <li><a href="#">-Copia de cedula de identidad del propietario o representante legal</a></li>
			  <li><a href="#">-Plan de emergencia y autoprotección, obligatoriedad a establecimientos que determina la ley.</a></li>
      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row">
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/permi-1.jpg" alt="">
...
<a href="contactenos.html" class="btn2">saber mas >></a>
          ...
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/permi-2.jpg" alt="">
          ...
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/planes-e.jpg" alt="">
	 ...
	 <section class="well1 bg1">
      <div class="container wow fadeInUp">
        ...
        <div class="row">
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/permi-5.jpg" alt="">
          ...
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/permi-4.jpg" alt="">
          ...
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/bobo.jpg" alt="">
	...
	<section class="well1 bg1">
      <div class="container wow fadeInUp">
        ...
        <div class="row">
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/bobo2.jpg" alt="">
          ...
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/bobo3.jpg" alt="">
          ...
          <div class="col-xs-offset-2 col-xs-8 col-sm-offset-0 col-sm-4">
            <img src="assets/img/bobo5.jpg" alt="">
                ...
                <div>
                  <div class="tab-box">
                    <div class="tab-box_aside">
                      <img src="assets/img/alerta2.jpg" alt="">
                    </div>
...
Observe y no olvide donde guardan en la casa la lámpara o linterna y asegúrese que tenga pilas. Manténgase informado, escuche las noticias con atención. </p>
                ...
                <div>
                  <div class="tab-box">
                    <div class="tab-box_aside">
                      <img src="assets/img/alerta3.jpg" alt="">
                    </div>
                    <div class="tab-box_cnt__no-flow">
...
Comunícate de ser posible al cuerpo de bomberos o con cualquier servicio de emergencia e indícales tu posición</p>
          ...
          <div class="col-xs-12 col-sm-4">
            ...
            <a class="" href="../panel_ley_transparecia/lista_bomberos/voluntarios_lista2.php">
              <img src="assets/img/page-1_img09.png" alt="">
              <span>Llamenos</span>
            </a>
          </div>
        </div>
      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-4">
            <div class="box">
              <span class="icon">
                <img src="assets/img/page-4_img02.png" alt="">
              </span>
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="box">
              <span class="icon">
                <img src="assets/img/page-4_img03.png" alt="">
              </span>
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="box">
              <span class="icon">
                <img src="assets/img/page-4_img04.png" alt="">
              </span>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-3">
            ...
            <ul class="list">
              ...
              <li><a href="http://www.ministeriointerior.gob.ec/"><img src="assets/img/logo-min.png" alt=""/></a></li>
            </ul>
          </div>
          <div class="col-xs-12 col-sm-3">
            ...
            <ul class="list">
              ...
              <li><a href="https://www.youtube.com/watch?v=m5eT_xGXWrs"><i class="fa fa-youtube aria-hidden="true"></i></a></li>
                          ...
                          <li><a href="http://www.gestionderiesgos.gob.ec/"><img src="assets/img/logp-sng.png" alt=""/></a></li>
            </ul>
          </div>
          <div class="col-xs-12 col-sm-3">
            <h3>PREVENCION</h3>
            <ul class="list">
              ...
              <li><a href="http://www.ecu911.gob.ec/"><img src="assets/img/page-1_img08.png" alt=""/></a></li>
            </ul>
          </div>
          <div class="col-xs-12 col-sm-3">
            <h3>NOSOTROS</h3>
